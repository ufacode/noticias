...
ActiveRecord::Schema.define(version: 20161001091106) do
  ...
  create_table "memberships", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    ...
    t.index ["user_id", "contact_id"], name: "index_memberships_on_user_id_and_contact_id", unique: true, using: :btree
